...
namespace Velvet.GameSystems
{
    public class CameraZoom : CameraEffect
    {
        ...
        private void GradualZoom(float _targetZoomValue, double deltaTime, float _timeInMilliseconds = 200f, float _acceleration = 0)
        {
        ...
        private void SnapZoomToIntegers(float tolerance)
        {

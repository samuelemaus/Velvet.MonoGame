...
namespace Velvet.UI
{
    public class ViewGrid
    {
        ...
        /// <summary>
        /// Primary 2-Dimensional <see cref="Array"/> of <see cref="GridCell"/>s.  Contains all <see cref="IBindableViewObject"/>s in this <see cref="ViewGrid"/>.
        /// </summary>
        ...
        /// <summary>
        /// Reduces number of <see cref="GridCell"/>s to minimum necessary for active <see cref="IBindableViewObject"/>s for this <see cref="ViewGrid"/>.
        /// </summary>

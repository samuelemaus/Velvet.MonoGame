...
//        public Alignment Lucasalignment = Alignment.Centered;

//        int alignmentIndex = Alignment.ReferencePoints.IndexOf(Alignment.Centered);
...
//        void ToggleLucasalignment()
//        {
//            alignmentIndex = ValueRange.Enforce(alignmentIndex + 1, 0, Alignment.ReferencePoints.Count -1, true);

//            Lucas.SetOriginByReferencePoint(Alignment.ReferencePoints[alignmentIndex]);
//        }
...
//        {
//            return Input.Mouse.Pointer.CreatedRect.CenterPosition;
//        }
...
//            spriteBatch.DrawCircle(Lucas.BoundingRect.CenterPosition, 3f, 5, Color.Black* 0.65f);
//            spriteBatch.DrawCircle(Lucas.CenterPosition, 3f, 5, Color.DarkGoldenrod * 0.65f);
...
//            }
//            var spobles = Beach.CenterPosition;
//        }
